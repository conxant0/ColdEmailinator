...
- Reply detection includes a single automatic retry after 10 seconds
  to account for Gmail API sync delay — if no reply is found on either
  check, the user is prompted to run parse.py again.
